...
import { Mail, Lock, BookOpen, ArrowRight, Eye, EyeOff, Sparkles } from 'lucide-react';
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200/50 border border-white/50 p-8">
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-violet-50 border border-violet-100 rounded-full mb-4">
                            ...
                            <span className="text-sm font-medium text-violet-700">Welcome Back</span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="remember-me" className="ml-2.5 text-sm text-gray-600 cursor-pointer">
                                Keep me signed in
                            </label>
                        </div>
